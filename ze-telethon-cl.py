...
try:
    ...
    api_id = '22912797'
    api_hash = '568164162de9a923012c3e22de3d0a65'
    bot_token = '6706625265:AAFN8QcqBHij8eSR5W8h0lG4P3mD8aimcqo'
    DEVLOO = '6550524025'
    MAX_ACCOUNTS = int('30')
    user_bot = 'yahyahabot'
    id_bot = int('6706625265')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6550524025))
